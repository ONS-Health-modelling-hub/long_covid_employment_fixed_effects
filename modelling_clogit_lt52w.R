modelling.clogit.lt52w <- function(dset, chart_cols, out_dir, outcome,
  ...
  if(run_mod2==TRUE) {
    ...
    or2$exposure <- factor(or2$exposure,
                           labels=c("<12 weeks",
                                    ...
                                    "40 to <52 weeks, previously infected",
                                    ...
                                    "40 to <52 weeks, current Long Covid",
                                    ...
                                    "40 to <52 weeks, previous Long Covid"))
